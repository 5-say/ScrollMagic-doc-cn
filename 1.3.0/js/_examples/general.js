...
var
    MENU = {
        "basic": {
            title: "Basic",
            sub: {
                "simple_tweening.html"    : "简单的补间动画",
                "simple_pinning.html"     : "简单的悬停效果",
                "going_horizontal.html"   : "横向滚动",
                "debugging.html"          : "调试模式",
                "custom_actions.html"     : "自定义事件",
                "scene_manipulation.html" : "操控场景",
                "class_toggles.html"      : "目标导航样式切换"
            }
        },
        "advanced": {
            title: "Advanced",
            sub: {
                "advanced_tweening.html"     : "高级补间动画",
                "custom_containers.html"     : "自定义容器",
                "mobile_basic.html"          : "移动设备支持 (基础)",
                "anchor_link_scrolling.html" : "锚点滚动",
                "parallax_scrolling.html"    : "视差滚动",
                "parallax_sections.html"     : "分段视差",
                "infinite_scrolling.html"    : "无限滚动",
                "svg_drawing.html"           : "SVG 绘图"
            }
        },
        "expert": {
            title: "Expert",
            sub: {
                "cascading_pins.html"             : "连锁悬停",
                "responsive_duration.html"        : "响应时间",
                "manipulating_tweens.html"        : "操控补间动画",
                "bezier_path_animation.html"      : "贝塞尔路径动画",
                "multiple_scroll_directions.html" : "多个滚动方向",
                "mobile_advanced.html"            : "移动设备支持 (高级)",
                "image_sequence.html"             : "图像序列",
                "removing_and_destroying.html"    : "删除和销毁"
            }
        }
    };
